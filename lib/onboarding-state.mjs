...
export function restoreOnboardingState(draft){
 if(!draft||typeof draft!=='object'||!RESUMABLE_STEPS.has(draft.step)||typeof draft.operationKey!=='string'||draft.operationKey.length<8||!draft.data||typeof draft.data!=='object'||draft.data.consentAccepted!==true)return initialOnboardingState();
