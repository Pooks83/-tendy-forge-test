...
export function generateMission(context){
 ...
 if(evaluated.eligible.length<count){
  const unreviewed=(context.catalog||[]).some(item=>item.contentStatus!=='PUBLISHED');
