...
const AGE_BANDS=new Set(['8–10','11–12','13–14']);
...
export function buildPlayerProjection(profile,state){
 ...
 return {
  profile:cleanRecord(profile,['id','nickname','ageBand','catches','experience','equipment','plannedDays','missionMinutes','setupStatus']),
  training:{
