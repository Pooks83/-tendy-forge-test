...
export function normalizeOnboardingInput(input){
 ...
 const spaces=input.spaces===undefined?[]:input.spaces;
 if(!Array.isArray(spaces)||spaces.some(item=>!SPACES.has(item))||new Set(spaces).size!==spaces.length)invalid('Check the available training space.');
