...
type Props={player:PlayerProjection;initialStep?:Step;resume?:boolean;onStartMission:()=>void;onStop:()=>Promise<boolean>;onParent:()=>Promise<void>};
...
export function PlayerFirstValueFlow({player,initialStep='goalie-welcome',resume=false,onStartMission,onStop,onParent}:Props){
